...
export function buildScriptServices(deps: ScriptServiceAdapterDeps): ScriptServices {
    ...
    const services: ScriptServices = {
        ...
        combat: {
            ...
            applyPrayers: (player, prayers) => deps.prayerSystem.applyPrayers(player, prayers),
            ...
            queueCombatState: (player) => deps.queueCombatSnapshot(
                ...
                player.combat?.activeStyle,
                player.combat?.activePrayers,
                player.combat?.activeSpellId,
            ),

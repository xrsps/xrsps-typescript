...
export interface SkillActionServices {
    ...
    onLeagueTaskItemObtain?(player: PlayerState, itemId: number, quantity?: number): void;
    onLeagueTaskItemCraft?(player: PlayerState, itemId: number, quantity?: number): void;
    onLeagueTaskNpcPickpocket?(player: PlayerState, npcId: number, count?: number): void;
...
export class SkillActionHandler {
    private notifyItemObtain(player: PlayerState, itemId: number, quantity: number = 1): void {
        this.services.onLeagueTaskItemObtain?.(player, itemId, quantity);
    }

    private notifyItemCraft(player: PlayerState, itemId: number, quantity: number = 1): void {
        this.services.onLeagueTaskItemCraft?.(player, itemId, quantity);
        this.notifyItemObtain(player, itemId, quantity);
    }
    ...
    executeSkillSmithAction(
        ...
        this.notifyItemCraft(player, recipe.outputItemId, Math.max(1, recipe.outputQuantity));
    ...
    executeSkillCookAction(
        ...
        this.notifyItemCraft(player, producedItemId, 1);
    ...
    executeSkillTanAction(
        ...
        this.notifyItemCraft(player, recipe.outputItemId, 1);
    ...
    executeSkillFletchAction(
        ...
        this.notifyItemCraft(player, recipe.productItemId, productQuantity);
    ...
    executeSkillSinewAction(
        ...
        this.notifyItemCraft(player, SINEW_ITEM_ID, 1);
    ...
    executeSkillFlaxAction(
        ...
        if (result.added > 0) {
            this.notifyItemObtain(player, FLAX_ITEM_ID, result.added);
    ...
    executeSkillMiningAction(
        ...
        if (success) {
            if (hasEchoPickaxePerk) {
                ...
                this.notifyItemObtain(player, rock.oreItemId, 1);
                bankSnapshot = true;
            } else {
                ...
                this.notifyItemObtain(player, rock.oreItemId, result.added);
    ...
    executeSkillFishingAction(
        ...
        if (success) {
            ...
            if (hasEchoHarpoonPerk) {
                ...
                this.notifyItemObtain(player, rewardItemId, quantity);
                bankSnapshot = true;
            } else {
                ...
                this.notifyItemObtain(player, rewardItemId, result.added);
                inventorySnapshot = true;
            }
    ...
    executeSkillBoltEnchantAction(
        ...
        this.notifyItemCraft(player, enchantedItemId, addResult.added);
    ...
    executeSkillWoodcutAction(
        ...
        if (success) {
            if (hasEchoAxePerk) {
                ...
                this.notifyItemObtain(player, tree.logItemId, 1);
                bankSnapshot = true;
            } else {
                ...
                this.notifyItemObtain(player, tree.logItemId, result.added);
                inventorySnapshot = true;
            }
        ...
        if (data.phase === 1) {
            ...
            if (success) {
                ...
                if (reward) {
                    ...
                    const added = this.services.addItemToInventory(player, itemId, qty);
                    if (added.added > 0) {
                        this.notifyItemObtain(player, itemId, added.added);
                    }
                    effects.push({ type: "inventorySnapshot", playerId: player.id });
                ...
                this.services.onLeagueTaskNpcPickpocket?.(player, data.npcTypeId, 1);
                effects.push(
                    this.services.buildSkillMessageEffect(
                        player,
